...
#define kPopupModalAnimationDuration 0.23
...
- (void)dismissPopupViewControllerWithanimationType:(MJPopupViewAnimation)animationType
{
    ...
    UIView *topView = [[self.view.window subviews] lastObject];

    UIView *sourceView = [self topView];
    UIView *popupView = [sourceView.tag == kMJSourceViewTag ? sourceView : topView viewWithTag:kMJPopupViewTag];
    UIView *overlayView = [sourceView.tag == kMJSourceViewTag ? sourceView : topView viewWithTag:kMJOverlayViewTag];
...
- (void)slideViewIn:(UIView*)popupView sourceView:(UIView*)sourceView overlayView:(UIView*)overlayView withAnimationType:(MJPopupViewAnimation)animationType
{
    ...
    CGRect popupEndRect = CGRectMake((sourceSize.width - popupSize.width - 100),
                                     (sourceSize.height - popupSize.height) / 2,
                                     popupSize.width,
                                     popupSize.height);
